...
echo "[*] Starting node"
GLOBAL_ARGS='--syncmode full --mine --rpc --rpcaddr 0.0.0.0 --rpccorsdomain "remix.ethereum.org" --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul'
