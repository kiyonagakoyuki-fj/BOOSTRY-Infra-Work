...
echo "[*] Starting node"
GLOBAL_ARGS="--datadir /qdata/dd --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,istanbul --permissioned --rpcport 8545 --port 21000"
